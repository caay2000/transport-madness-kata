...
class UpdateLocationOnEntityLoadedEventSubscriber(locationRepository: LocationRepository, eventPublisher: EventPublisher) : EventSubscriber<EntityLoadedEvent> {
