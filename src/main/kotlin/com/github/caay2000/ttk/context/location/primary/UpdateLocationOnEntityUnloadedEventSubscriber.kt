...
class UpdateLocationOnEntityUnloadedEventSubscriber(locationRepository: LocationRepository, eventPublisher: EventPublisher<Event>) : EventSubscriber<EntityUnloadedEvent> {
